export default function Head({ currentPage = "Home" }) {
  const pageTitle = `${
    currentPage === "Home"
      ? "Aman Kuamr - Web Developer, Designer and Creator."
      : `${currentPage} - Aman Kuamr`
  }`;
  const desc =
  ...
  return (
    <>
      ...
      <meta
        name="keywords"
        content="Aman Kuamr, Aman Kuamr, freelancers, react developer, reactjs freelancer, nextjs"
      />
      ...
      />
      <link rel="manifest" href={`${process.env.NEXT_PUBLIC_BASE_URL}static/favicon/site.webmanifest`} />
      <link rel="canonical" href="https://Aman Kuamr.js.org/" />
      <meta name="title" content={pageTitle} />
      <meta name="description" content={desc} />

      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://Aman Kuamr.js.org/" />
      <meta property="og:title" content={pageTitle} />
      <meta property="og:description" content={desc} />
      <meta
        property="og:image"
        content="https://Aman Kuamr.js.org/static/misc/og.png"
      />

      <meta property="twitter:card" content="summary_large_image" />
      <meta property="twitter:url" content="https://Aman Kuamr.js.org/" />
